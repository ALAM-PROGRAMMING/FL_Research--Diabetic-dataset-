...
def load_data():
    ...
    # Strictly bind this client to the India dataset only.
    df = pd.read_csv("../data/processed/india_cleaned_aligned.csv")
    ...
    # Using 128 batch size because India dataset is substantially smaller
...
def main():
    ...
    model = DiabetesMLP(input_dim=9).to(device)
