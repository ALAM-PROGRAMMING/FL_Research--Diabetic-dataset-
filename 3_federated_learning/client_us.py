...
def load_data():
    ...
    # Strictly bind this client to the US dataset only. True decentralization.
    df = pd.read_csv("../data/processed/us_cleaned_aligned.csv")
    ...
    # Using 1024 because the US dataset is massive
